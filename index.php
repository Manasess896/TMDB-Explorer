        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'movies' ? 'active' : '' ?>" href="index.php?page=movies">Movies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'tvshows' ? 'active' : '' ?>" href="index.php?page=tvshows">TV Shows</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'discover' ? 'active' : '' ?>" href="index.php?page=discover">Discover</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page == 'people' ? 'active' : '' ?>" href="index.php?page=people">People</a>
                    </li>
                </ul>
        ...
        <section class="py-5">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="index.php?page=discover&type=movie&sort_by=popularity.desc" class="btn btn-outline-primary" data-aos="fade-left">View All</a>
                </div>
        ...
        <section class="py-5 bg-alt">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="index.php?page=discover&type=movie&sort_by=release_date.desc" class="btn btn-outline-primary" data-aos="fade-left">View All</a>
                </div>
                <div class="row content-slider">
        ...
        <section class="py-5">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="index.php?page=tvshows" class="btn btn-outline-primary" data-aos="fade-left">View All</a>
                </div>
                <div class="row content-slider">
        ...
        <section class="py-5 bg-alt">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="index.php?page=discover&type=tv&sort_by=popularity.desc" class="btn btn-outline-primary" data-aos="fade-left">View All</a>
                </div>
                <div class="row content-slider">
                    ...
                    <div class="card-body">
                        <form action="index.php" method="GET" class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <a href="index.php?page=discover&type=<?= $discoverType ?>" class="btn btn-outline-secondary">Reset Filters</a>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="py-5">
            <div class="container">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        <li class="page-item <?= $currentPage <= 1 ? 'disabled' : '' ?>">
                            <a class="page-link" href="index.php?page=movies&movie_page=<?= $currentPage - 1 ?>">Previous</a>
                        </li>
                        <?php
                        $startPage = max(1, $currentPage - 2);
                        ...
                        ?>
                            <li class="page-item <?= $i == $currentPage ? 'active' : '' ?>">
                                <a class="page-link" href="index.php?page=movies&movie_page=<?= $i ?>"><?= $i ?></a>
                            </li>
                        <?php endfor; ?>
                        <li class="page-item <?= $currentPage >= $totalPages ? 'disabled' : '' ?>">
                            <a class="page-link" href="index.php?page=movies&movie_page=<?= $currentPage + 1 ?>">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $year ?></td>
                                                    <td>
                                                        <a href="index.php?page=movie&id=<?= $credit['id'] ?>">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $year ?></td>
                                                    <td>
                                                        <a href="index.php?page=tvshow&id=<?= $credit['id'] ?>">
